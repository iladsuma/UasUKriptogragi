...
public class Main {
...

    {
        ...
        // y dan r bukan hexa jadi tidak bisa digunakan untuk hex ke binary pada long parselong, maka dari itu saya ganti dengan huruf ascii. ttd iladsuma
        // maka dari itu saya Konversikan string ke representasi yang berbeda sebelum menguraikannya dengan Long.parseLong. 
